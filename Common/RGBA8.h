...
public:
	...
	static RGBA8 fromHsv(unsigned _h, uint8_t _s, uint8_t _v) { RGBA8 c; c.setHsv(_h, _s, _v); return c; }
	static RGBA8 fromHsp(unsigned _h, uint8_t _s, uint8_t _v) { RGBA8 c; c.setHsp(_h, _s, _v); return c; }
	...
	friend inline std::ostream& operator<<(std::ostream& _o, RGBA8 const& _this) { return _o << "#" << std::hex << std::setw(2) << std::setfill('0') << (int)_this.r() << std::setw(2) << std::setfill('0') << (int)_this.g() << std::setw(2) << std::setfill('0') << (int)_this.b() << std::dec; }
...
typedef std::vector<RGBA8> RGBA8s;
