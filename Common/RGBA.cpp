...
RGBA const RGBA::Green(0.15f, 0.75f, 0.1f, 1.f);
RGBA const RGBA::Blue(0.15f, 0.2f, 1.0f, 1.f);
RGBA const RGBA::Indigo(0.45f, 0.1f, 0.95f, 1.f);
RGBA const RGBA::Violet(0.95f, 0.05f, 0.5f, 1.f);
