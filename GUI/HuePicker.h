...
public:
	...
	void setMiddle(Color _c) { if (m_middle != _c) { m_middle = _c; update(2); } }
...
protected:
	...
	virtual void hueChanged(bool _userEvent) { if (m_onHueChanged && _userEvent) m_onHueChanged(this); update(2); }
