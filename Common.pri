...
inline_resource_compiler1.input = LB_RES2
...
inline_resource_compiler2.input = LB_RES2
inline_resource_compiler2.commands = \
	echo "// $(echo '${QMAKE_FILE_IN_BASE}${QMAKE_FILE_EXT}' | sed 's/\\\\./_/') ${QMAKE_FILE_IN} ${QMAKE_FILE_IN_BASE}" > ${QMAKE_FILE_OUT}
